...
interface Integration {
  ...
  iconType?: 'fab' | 'fas';
  color: string;
  category: 'connected' | 'sales' | 'shipping' | 'automation' | 'marketing-ads' | 'marketing-email' | 'marketing-analytics';
...
export function IntegrationsSettings() {
  ...
  const renderIcon = (integration: Integration, size: 'sm' | 'lg' = 'sm') => {
