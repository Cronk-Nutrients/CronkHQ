...
"[project]/hooks/useFirestore.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useFirestoreCollection(collectionName, queryConstraints = [], enabled = true) {
    ...
    const service = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useFirestoreCollection.useMemo[service]": ()=>{
            if (!orgId) return null;
            // Skip Firestore for demo org
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isDemoOrganization"])(orgId)) return null;
            return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirestoreService"](orgId, collectionName);
        }
    }["useFirestoreCollection.useMemo[service]"], [
        orgId,
        collectionName
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useFirestoreCollection.useEffect": ()=>{
            // For demo mode, don't fetch from Firestore
            if (!orgId || (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isDemoOrganization"])(orgId)) {
                setLoading(false);
                return;
            }
            if (!service || !enabled) {
            ...
            const unsubscribe = service.subscribe({
                "useFirestoreCollection.useEffect.unsubscribe": (newData)=>{
                    setData(newData);
                    setLoading(false);
                    setError(null);
                }
            }["useFirestoreCollection.useEffect.unsubscribe"], {
                "useFirestoreCollection.useEffect.unsubscribe": (err)=>{
                    console.error(`Error fetching ${collectionName}:`, err);
                    setError(err);
                    setLoading(false);
                }
            }["useFirestoreCollection.useEffect.unsubscribe"], ...queryConstraints);
            return ({
                "useFirestoreCollection.useEffect": ()=>unsubscribe()
            })["useFirestoreCollection.useEffect"];
        }
    ...
    const create = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFirestoreCollection.useCallback[create]": async (item)=>{
            if (!service) throw new Error('No organization or in demo mode');
            return service.create(item);
        }
    }["useFirestoreCollection.useCallback[create]"], [
        service
    ]);
    const update = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFirestoreCollection.useCallback[update]": async (id, updates)=>{
            if (!service) throw new Error('No organization or in demo mode');
            return service.update(id, updates);
        }
    }["useFirestoreCollection.useCallback[update]"], [
        service
    ]);
    const remove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFirestoreCollection.useCallback[remove]": async (id)=>{
            if (!service) throw new Error('No organization or in demo mode');
            return service.delete(id);
        }
    }["useFirestoreCollection.useCallback[remove]"], [
        service
    ]);
    const getById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFirestoreCollection.useCallback[getById]": async (id)=>{
            if (!service) throw new Error('No organization or in demo mode');
            return service.get(id);
        }
    }["useFirestoreCollection.useCallback[getById]"], [
        service
    ]);
    return {
        data,
        ...
        getById,
        service,
        isDemo: orgId ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isDemoOrganization"])(orgId) : false
    };
}
_s(useFirestoreCollection, "9Sw5h5XWVZO2sJ6Q/IOIyO0PbXg=", false, function() {
    return [
...
function useProducts() {
    ...
    const result = useFirestoreCollection('products', [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderBy"])('name')
    ]);
    return {
...
_s1(useProducts, "HfROs8e6w/dhg3wxSXz0Cj1KtU8=", false, function() {
    return [
...
function useProduct(productId) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useProduct.useEffect": ()=>{
            if (!orgId || !productId || (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isDemoOrganization"])(orgId)) {
                setLoading(false);
                return;
            }
            const service = new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirestoreService"](orgId, 'products');
            const unsubscribe = service.subscribeToDoc(productId, {
                "useProduct.useEffect.unsubscribe": (data)=>{
                    setProduct(data);
                    setLoading(false);
                }
            }["useProduct.useEffect.unsubscribe"], {
                "useProduct.useEffect.unsubscribe": (err)=>{
                    setError(err);
                    setLoading(false);
                }
            }["useProduct.useEffect.unsubscribe"]);
...
_s2(useProduct, "HPDw2jFxiGdknLaL64t/krqOFWw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$OrganizationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOrganization"]
    ];
});
function useOrders(status) {
    ...
    if (status && status !== 'all') {
        constraints.unshift((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])('status', '==', status));
    }
...
_s3(useOrders, "HfROs8e6w/dhg3wxSXz0Cj1KtU8=", false, function() {
    return [
        useFirestoreCollection
    ];
});
function useRecentOrders(count = 10) {
    ...
    const result = useFirestoreCollection('orders', [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderBy"])('createdAt', 'desc'),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["limit"])(count)
    ]);
    return {
        orders: result.data,
        ...result
...
_s4(useRecentOrders, "HfROs8e6w/dhg3wxSXz0Cj1KtU8=", false, function() {
    return [
        useFirestoreCollection
    ];
});
...
_s5(usePurchaseOrders, "HfROs8e6w/dhg3wxSXz0Cj1KtU8=", false, function() {
    return [
        useFirestoreCollection
    ];
});
...
_s6(useWorkOrders, "HfROs8e6w/dhg3wxSXz0Cj1KtU8=", false, function() {
    return [
        useFirestoreCollection
    ];
});
...
_s7(useSuppliers, "HfROs8e6w/dhg3wxSXz0Cj1KtU8=", false, function() {
    return [
        useFirestoreCollection
    ];
});
...
_s8(useLocations, "HfROs8e6w/dhg3wxSXz0Cj1KtU8=", false, function() {
    return [
        useFirestoreCollection
    ];
});
...
_s9(useReturns, "HfROs8e6w/dhg3wxSXz0Cj1KtU8=", false, function() {
    return [
        useFirestoreCollection
    ];
});
...
_s10(useStockTransfers, "HfROs8e6w/dhg3wxSXz0Cj1KtU8=", false, function() {
    return [
        useFirestoreCollection
    ];
});
...
_s11(useBundles, "HfROs8e6w/dhg3wxSXz0Cj1KtU8=", false, function() {
    return [
        useFirestoreCollection
    ];
});
function useInventory(locationId) {
    ...
    const constraints = [];
    if (locationId) {
        constraints.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])('locationId', '==', locationId));
    }
...
_s12(useInventory, "HfROs8e6w/dhg3wxSXz0Cj1KtU8=", false, function() {
    return [
        useFirestoreCollection
    ];
});
function useLowStockProducts() {
    ...
    const lowStock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useLowStockProducts.useMemo[lowStock]": ()=>{
            return products.filter({
                "useLowStockProducts.useMemo[lowStock]": (p)=>{
    ...
    const outOfStock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useLowStockProducts.useMemo[outOfStock]": ()=>{
...
_s13(useLowStockProducts, "dUVD2VPGSGfEaF1ZBkSdSQ2r2cA=", false, function() {
    return [
        useProducts
    ];
});
function useDashboardStats() {
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useDashboardStats.useMemo[stats]": ()=>{
            const today = new Date();
            today.setHours(0, 0, 0, 0);
            const todayOrders = orders.filter({
                "useDashboardStats.useMemo[stats].todayOrders": (o)=>{
                    const createdAt = o.createdAt;
                    const orderDate = typeof createdAt === 'string' ? new Date(createdAt) : createdAt instanceof Date ? createdAt : new Date();
                    return orderDate >= today;
                }
            }["useDashboardStats.useMemo[stats].todayOrders"]);
            const pendingOrders = orders.filter({
                "useDashboardStats.useMemo[stats].pendingOrders": (o)=>[
                        'pending',
                        'to_pick',
                        'to_pack'
                    ].includes(o.status)
            }["useDashboardStats.useMemo[stats].pendingOrders"]);
            const shippedToday = orders.filter({
                "useDashboardStats.useMemo[stats].shippedToday": (o)=>{
            ...
            }["useDashboardStats.useMemo[stats].shippedToday"]);
            return {
                todayOrders: todayOrders.length,
                todayRevenue: todayOrders.reduce({
                    "useDashboardStats.useMemo[stats]": (sum, o)=>sum + (o.total || 0)
                }["useDashboardStats.useMemo[stats]"], 0),
...
_s14(useDashboardStats, "pMG5q18hekEhfBPZJWORrbe9XDk=", false, function() {
    return [
        useOrders,
        useProducts
    ];
...
function useProductsWithInventory() {
    ...
    const productsWithStock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useProductsWithInventory.useMemo[productsWithStock]": ()=>{
            return products.map({
                "useProductsWithInventory.useMemo[productsWithStock]": (product)=>{
                    const stockItems = inventory.filter({
                        "useProductsWithInventory.useMemo[productsWithStock].stockItems": (i)=>i.productId === product.id
                    }["useProductsWithInventory.useMemo[productsWithStock].stockItems"]);
                    const totalStock = stockItems.reduce({
                        "useProductsWithInventory.useMemo[productsWithStock].totalStock": (sum, i)=>sum + i.quantity
                    }["useProductsWithInventory.useMemo[productsWithStock].totalStock"], 0);
                    return {
                        ...product,
                        totalStock,
...
_s15(useProductsWithInventory, "TRtKBKD9R/2P0uccl4SBZx8cwME=", false, function() {
    return [
        useProducts,
        useInventory
    ];
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Modal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/Modal.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/Button.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useFirestore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/Toast.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
...
function ImportCSVModal({ isOpen, onClose }) {
    _s();
    const { locations } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocations"])();
    const { suppliers: existingSuppliers, service: supplierService, isDemo } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSuppliers"])();
    const { products: existingProducts, service: productService } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProducts"])();
    const { service: inventoryService } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useInventory"])();
    ...
    const [createInventoryRecords, setCreateInventoryRecords] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [createSuppliers, setCreateSuppliers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const handleImport = async ()=>{
        ...
        try {
            const existingSkus = new Set(existingProducts.map((p)=>p.sku.toLowerCase()));
            const supplierMap = new Map(existingSuppliers.map((s)=>[
                    s.name.toLowerCase(),
                    s
                ]));
            let imported = 0;
                ...
                isDemo && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: "Import is disabled in demo mode. Sign in to import products."
                            }, void 0, false, {
                                fileName: "[project]/components/modals/ImportCSVModal.tsx",
                                lineNumber: 565,
                                columnNumber: 13
    ...
    const renderFieldGroup = (groupName, fields, icon, color)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ImportCSVModal, "oNADKnMO2wVmgUVfhK3aWDX6UtA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocations"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSuppliers"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProducts"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useInventory"],
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
_c = ImportCSVModal;
...
"[project]/components/modals/ImportInflowModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ImportInflowModal({ isOpen, onClose }) {
    _s();
    const { locations } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocations"])();
    const { suppliers: existingSuppliers, service: supplierService, isDemo } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSuppliers"])();
    const { products: existingProducts, service: productService } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProducts"])();
    ...
    const [step, setStep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('upload');
    const [fileName, setFileName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [parsedProducts, setParsedProducts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [selectedLocationId, setSelectedLocationId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [createInventoryRecords, setCreateInventoryRecords] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [createVendors, setCreateVendors] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [isDragging, setIsDragging] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const handleFileSelect = (file)=>{
        ...
        reader.onload = (e)=>{
            ...
            const products = rows.map((row)=>mapInflowRow(row)).filter((p)=>p !== null);
    ...
    const handleDrop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ImportInflowModal.useCallback[handleDrop]": (e)=>{
            e.preventDefault();
            setIsDragging(false);
            const file = e.dataTransfer.files[0];
            if (file) handleFileSelect(file);
        }
    }["ImportInflowModal.useCallback[handleDrop]"], []);
    const handleDragOver = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ImportInflowModal.useCallback[handleDragOver]": (e)=>{
            e.preventDefault();
            setIsDragging(true);
        }
    }["ImportInflowModal.useCallback[handleDragOver]"], []);
    const handleDragLeave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ImportInflowModal.useCallback[handleDragLeave]": ()=>{
            setIsDragging(false);
        }
    }["ImportInflowModal.useCallback[handleDragLeave]"], []);
    const handleFileInputChange = (e)=>{
    ...
    const renderUploadStep = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("i", {
                                    className: "fas fa-exchange-alt text-blue-400 text-xl"
                                }, void 0, false, {
                                    fileName: "[project]/components/modals/ImportInflowModal.tsx",
                                    lineNumber: 431,
                                    columnNumber: 13
                                }, this)
                            }, void 0, false, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm text-slate-400",
                                        children: "Directly import product data exported from inFlow Inventory"
                                    }, void 0, false, {
                                        fileName: "[project]/components/modals/ImportInflowModal.tsx",
                                        lineNumber: 435,
                                        columnNumber: 13
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    onDragLeave: handleDragLeave,
                    onClick: ()=>fileInputRef.current?.click(),
                    className: `border-2 border-dashed rounded-xl p-8 text-center cursor-pointer transition-colors ${isDragging ? 'border-blue-500 bg-blue-500/10' : 'border-slate-700 hover:border-slate-600'}`,
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                            ref: fileInputRef,
                            type: "file",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("i", {
                            className: "fas fa-file-csv text-4xl text-slate-500 mb-4"
                        }, void 0, false, {
                            fileName: "[project]/components/modals/ImportInflowModal.tsx",
                            lineNumber: 460,
                            columnNumber: 9
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-white font-medium mb-1",
                            children: "Drop your inFlow CSV export here"
                        }, void 0, false, {
                            fileName: "[project]/components/modals/ImportInflowModal.tsx",
                            lineNumber: 461,
                            columnNumber: 9
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                            className: "text-sm font-medium text-white mb-2",
                            children: "How to Export from inFlow"
                        }, void 0, false, {
                            fileName: "[project]/components/modals/ImportInflowModal.tsx",
                            lineNumber: 470,
                            columnNumber: 9
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ol", {
                            className: "text-sm text-slate-400 space-y-1 list-decimal list-inside",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                    children: [
                                        "In inFlow, go to ",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                    children: "Include: Name, Barcode, Category, Price, Cost, Quantity, Vendor"
                                }, void 0, false, {
                                    fileName: "[project]/components/modals/ImportInflowModal.tsx",
                                    lineNumber: 475,
                                    columnNumber: 11
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                            className: "text-sm font-medium text-white mb-2",
                            children: "Supported inFlow Columns"
                        }, void 0, false, {
                            fileName: "[project]/components/modals/ImportInflowModal.tsx",
                            lineNumber: 480,
                            columnNumber: 9
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                    className: "px-3 py-2 text-right text-slate-400 font-medium",
                                                    children: "Qty"
                                                }, void 0, false, {
                                                    fileName: "[project]/components/modals/ImportInflowModal.tsx",
                                                    lineNumber: 538,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                    className: "px-3 py-2 text-center text-slate-400 font-medium",
                                                    children: "Status"
                                                }, void 0, false, {
                                                    fileName: "[project]/components/modals/ImportInflowModal.tsx",
                                                    lineNumber: 541,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                        className: "divide-y divide-slate-700/50",
                                        children: parsedProducts.slice(0, 50).map((product, index)=>{
                                            const isDuplicate = existingSkus.has(product.sku.toLowerCase());
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                className: `${isDuplicate ? 'bg-amber-500/5' : 'bg-slate-800/30'}`,
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-3 py-2 text-white font-mono text-xs",
                                                        children: product.sku
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/modals/ImportInflowModal.tsx",
                                                        lineNumber: 549,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-3 py-2 text-right text-slate-300",
                                                        children: product.cost ? `$${product.cost.toFixed(2)}` : '-'
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/modals/ImportInflowModal.tsx",
                                                        lineNumber: 552,
                                                        columnNumber: 23
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-3 py-2 text-slate-300 truncate max-w-[120px]",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: isDuplicate ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        parsedProducts.length > 50 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "px-3 py-2 bg-slate-800/50 text-center text-sm text-slate-400",
                            children: [
                                "... and ",
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                    value: "",
                                                    children: "-- Don't import inventory --"
                                                }, void 0, false, {
                                                    fileName: "[project]/components/modals/ImportInflowModal.tsx",
                                                    lineNumber: 594,
                                                    columnNumber: 17
    ...
    const renderImportingStep = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "py-8 text-center",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "w-16 h-16 mx-auto mb-4 rounded-full bg-emerald-500/20 flex items-center justify-center",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("i", {
                        className: "fas fa-spinner fa-spin text-emerald-400 text-2xl"
                    }, void 0, false, {
                        fileName: "[project]/components/modals/ImportInflowModal.tsx",
                        lineNumber: 632,
                        columnNumber: 9
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: "Please wait while we import your data"
                }, void 0, false, {
                    fileName: "[project]/components/modals/ImportInflowModal.tsx",
                    lineNumber: 635,
                    columnNumber: 7
    ...
    const newProductCount = parsedProducts.filter((p)=>!existingProducts.some((ep)=>ep.sku.toLowerCase() === p.sku.toLowerCase())).length;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Modal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Modal"], {
        open: isOpen,
        ...
        footer: step === 'preview' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                    onClick: handleImport,
                    disabled: isDemo || newProductCount === 0,
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("i", {
                            className: "fas fa-file-import mr-2"
                        }, void 0, false, {
        ...
        }, void 0, true) : step === 'upload' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
            variant: "secondary",
            onClick: handleClose,
            children: "Cancel"
        }, void 0, false, {
...
_s(ImportInflowModal, "tpvQnm8LJsBs5+mV1DZn646BQ5s=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocations"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSuppliers"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFirestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProducts"],
...
_c = ImportInflowModal;
const __TURBOPACK__default__export__ = ImportInflowModal;
var _c;
__turbopack_context__.k.register(_c, "ImportInflowModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$modals$2f$ImportInflowModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/modals/ImportInflowModal.tsx [app-client] (ecmascript)");
...
function InventoryPageContent() {
    ...
    const [isInflowModalOpen, setIsInflowModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [showImportDropdown, setShowImportDropdown] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const getCategoryLabel = (category)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$inventory$2f$StatusBadge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["categoryStyles"][category]?.label || category;
    };
    // Handle row click
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$inventory$2f$StatusBadge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StockStatus"], {
                                        status: status
                                    }, void 0, false, {
                                        fileName: "[project]/app/(dashboard)/inventory/page.tsx",
                                        lineNumber: 736,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$modals$2f$ImportInflowModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ImportInflowModal"], {
...
_s(InventoryPageContent, "fmIlPIr51nkDgNa3eFhEIG9aARk=", false, function() {
    return [
...
//# sourceMappingURL=_14baa00f._.js.map