...
function PickPackOverviewPage() {
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PickPackOverviewPage.useMemo[stats]": ()=>{
            const toPick = state.orders.filter({
                "PickPackOverviewPage.useMemo[stats]": (o)=>o.status === 'to_pick'
            }["PickPackOverviewPage.useMemo[stats]"]).length;
            const picking = state.orders.filter({
                "PickPackOverviewPage.useMemo[stats]": (o)=>o.status === 'picking'
            }["PickPackOverviewPage.useMemo[stats]"]).length;
            const toPack = state.orders.filter({
                "PickPackOverviewPage.useMemo[stats]": (o)=>o.status === 'to_pack'
            }["PickPackOverviewPage.useMemo[stats]"]).length;
            const packing = state.orders.filter({
                "PickPackOverviewPage.useMemo[stats]": (o)=>o.status === 'packing'
            }["PickPackOverviewPage.useMemo[stats]"]).length;
            const readyToShip = state.orders.filter({
                "PickPackOverviewPage.useMemo[stats]": (o)=>o.status === 'ready'
            }["PickPackOverviewPage.useMemo[stats]"]).length;
            // Shipped today
            const today = new Date();
            today.setHours(0, 0, 0, 0);
            const shippedToday = state.orders.filter({
                "PickPackOverviewPage.useMemo[stats]": (o)=>{
    ...
    const pickQueue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PickPackOverviewPage.useMemo[pickQueue]": ()=>{
            return state.orders.filter({
                "PickPackOverviewPage.useMemo[pickQueue]": (o)=>o.status === 'to_pick' || o.status === 'picking'
            }["PickPackOverviewPage.useMemo[pickQueue]"]).sort({
                "PickPackOverviewPage.useMemo[pickQueue]": (a, b)=>new Date(a.createdAt).getTime() - new Date(b.createdAt).getTime()
            }["PickPackOverviewPage.useMemo[pickQueue]"]).slice(0, 5);
        }
    }["PickPackOverviewPage.useMemo[pickQueue]"], [
        state.orders
    ]);
    ...
    const packQueue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PickPackOverviewPage.useMemo[packQueue]": ()=>{
            return state.orders.filter({
                "PickPackOverviewPage.useMemo[packQueue]": (o)=>o.status === 'to_pack' || o.status === 'packing' || o.status === 'ready'
            }["PickPackOverviewPage.useMemo[packQueue]"]).sort({
                "PickPackOverviewPage.useMemo[packQueue]": (a, b)=>new Date(a.createdAt).getTime() - new Date(b.createdAt).getTime()
            }["PickPackOverviewPage.useMemo[packQueue]"]).slice(0, 5);
        }
    }["PickPackOverviewPage.useMemo[packQueue]"], [
        state.orders
    ]);
...
_s(PickPackOverviewPage, "V/IOe8FloHxiRza2YHCgNWhXow0=", false, function() {
    return [
...
_c = PickPackOverviewPage;
var _c;
__turbopack_context__.k.register(_c, "PickPackOverviewPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_51b16dbf._.js.map