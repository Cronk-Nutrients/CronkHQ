...
"[project]/app/pick-pack/pack/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PackPage() {
    ...
    const packableOrders = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PackPage.useMemo[packableOrders]": ()=>{
            return state.orders.filter({
                "PackPage.useMemo[packableOrders]": (o)=>o.status === 'to_pack' || o.status === 'packing'
            }["PackPage.useMemo[packableOrders]"]);
        }
    }["PackPage.useMemo[packableOrders]"], [
        state.orders
    ...
    const suggestedBox = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PackPage.useMemo[suggestedBox]": ()=>{
            ...
            return state.boxes.filter({
                "PackPage.useMemo[suggestedBox]": (box)=>box.smartBoxEligible
            }["PackPage.useMemo[suggestedBox]"]).filter({
                "PackPage.useMemo[suggestedBox]": (box)=>{
            ...
            }["PackPage.useMemo[suggestedBox]"]).sort({
                "PackPage.useMemo[suggestedBox]": (a, b)=>{
                    const volA = a.innerLength * a.innerWidth * a.innerHeight;
                    const volB = b.innerLength * b.innerWidth * b.innerHeight;
                    return volA - volB;
                }
            }["PackPage.useMemo[suggestedBox]"])[0] || null;
        }
    }["PackPage.useMemo[suggestedBox]"], [
        selectedOrder,
        state.boxes,
    ...
    const bottleCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PackPage.useMemo[bottleCount]": ()=>{
            if (!selectedOrder) return 0;
            return selectedOrder.items.reduce({
                "PackPage.useMemo[bottleCount]": (sum, item)=>sum + item.quantity
            }["PackPage.useMemo[bottleCount]"], 0);
        }
    }["PackPage.useMemo[bottleCount]"], [
        selectedOrder
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PackPage.useEffect": ()=>{
            const handleKeyDown = {
                "PackPage.useEffect.handleKeyDown": (e)=>{
            ...
            }["PackPage.useEffect.handleKeyDown"];
            window.addEventListener('keydown', handleKeyDown);
            return ({
                "PackPage.useEffect": ()=>window.removeEventListener('keydown', handleKeyDown)
            })["PackPage.useEffect"];
        }
    }["PackPage.useEffect"], []);
    // Handle scan/search
    ...
    const getChannelBadge = (channel)=>{
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            fileName: "[project]/app/pick-pack/pack/page.tsx",
            lineNumber: 345,
            columnNumber: 7
        }, this);
    };
...
_s(PackPage, "AZLTf8RcZ5okN0SEBZiQzcDkEGk=", false, function() {
    return [
...
//# sourceMappingURL=_739bde69._.js.map