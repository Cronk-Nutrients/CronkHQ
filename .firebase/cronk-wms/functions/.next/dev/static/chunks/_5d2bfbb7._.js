    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InventoryPage.useMemo[stats]": ()=>{
            ...
            const totalUnits = state.inventory.reduce({
                "InventoryPage.useMemo[stats].totalUnits": (sum, i)=>sum + i.quantity
            }["InventoryPage.useMemo[stats].totalUnits"], 0);
            let inventoryValue = 0;
            let costOnHand = 0;
            state.products.forEach({
                "InventoryPage.useMemo[stats]": (product)=>{
                    const stock = getProductStock(product.id);
            ...
            const lowStockCount = state.products.filter({
                "InventoryPage.useMemo[stats]": (p)=>getStockStatus(p) === 'low_stock'
            }["InventoryPage.useMemo[stats]"]).length;
            const outOfStockCount = state.products.filter({
                "InventoryPage.useMemo[stats]": (p)=>getStockStatus(p) === 'out_of_stock'
            }["InventoryPage.useMemo[stats]"]).length;
            return {
                totalProducts,
                totalUnits,
...
_s(InventoryPage, "nn4vyBf0XGcJN2pOYb2tUC6SGg4=", false, function() {
    return [
...
//# sourceMappingURL=_5d2bfbb7._.js.map