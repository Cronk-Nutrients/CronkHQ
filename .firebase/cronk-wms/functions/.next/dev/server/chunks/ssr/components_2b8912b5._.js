...
"[project]/components/returns/ReturnsConfig.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/returns/ReturnsBadges.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ReturnStatusBadge({ status, size = 'sm' }) {
    const config = __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$returns$2f$ReturnsConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["returnStatusConfig"][status];
...
function ConditionBadge({ condition }) {
    const config = __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$returns$2f$ReturnsConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["conditionLabels"][condition];
    const colorClasses = {
        emerald: 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20',
...
"[project]/components/returns/ReturnsStats.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/returns/index.ts [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=components_2b8912b5._.js.map