...
function PickPage() {
    ...
    const unassignedOrders = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["orders"].filter((o)=>o.status === 'to_pick' && !assignedOrderIds.includes(o.id));
    const getOrderById = (orderId)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["orders"].find((o)=>o.id === orderId);
    };
    const getPickItems = (batch)=>{
        ...
        for (const batchOrder of batch.orders){
            ...
            for (const item of order.items){
                if (item.productId) {
                    const product = (0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getProductById"])(item.productId);
                    const inv = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["inventory"].find((i)=>i.productId === item.productId && i.locationId === 'loc-1');
...
//# sourceMappingURL=_38f51544._.js.map